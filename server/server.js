...
const corsOptions = {
  origin: process.env.NODE_ENV === 'production' 
    ? ['https://efamilyserver.vercel.app', 'http://localhost:3000', 'http://localhost:3001', 'http://localhost:5173'] // 允许的前端域名
    : '*', // 开发环境下允许所有来源
  credentials: true,
...
app.listen(PORT, () => {
  const serverAddress = process.env.VERCEL ? 'https://efamilyserver.vercel.app' : `http://localhost:${PORT}`;
